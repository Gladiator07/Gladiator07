...
| [WSDM Cup - Multilingual Chatbot Arena](https://www.kaggle.com/competitions/wsdm-cup-multilingual-chatbot-arena) | Silver medal (31/950) | Kaggle | [code](https://github.com/Gladiator07/WSDM-Cup-2025-Kaggle) |
...
---
## ✍️ Blogs
- [**Using Google’s Agent Development Kit and Agent2Agent**](https://wandb.ai/gladiator/Google-Agent2Agent/reports/Using-Google-s-Agent-Development-Kit-and-Agent2Agent--VmlldzoxMjIyODEwOA) – Demonstrates how to build multi-agent systems using Google’s ADK and the Agent2Agent protocol for scalable, modular agent interactions.
- [**Deep Reinforcement Learning: Integrating neural networks with RL**](https://wandb.ai/gladiator/Reinforcement-learning-reports/reports/Deep-Reinforcement-Learning-Integrating-neural-networks-with-RL--VmlldzoxMjE2OTQ1Mw) – Breaks down how deep networks enable RL agents to process complex observations and learn effective policies end-to-end.
...
- [**Supervised learning vs deep learning vs reinforcement learning**](https://wandb.ai/gladiator/Reinforcement-learning-reports/reports/Supervised-learning-vs-deep-learning-vs-reinforcement-learning--VmlldzoxMjE0MzQ0NQ) – A comparative guide exploring how these core ML paradigms differ in mechanics, data efficiency, and deployment contexts.
